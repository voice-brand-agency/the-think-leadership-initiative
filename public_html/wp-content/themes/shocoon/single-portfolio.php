							...
							<div class="met_portfolio_item_slider_wrap clearfix">
								<div id="met_portfolio_item_slider_<?php the_ID() ?>" class="met_portfolio_item_slider">
									<?php foreach($gallery_images as $gallery_image): ?>
										<a href="<?php echo $gallery_image['full_url'] ?>" rel="lb_<?php the_ID() ?>"><img src="<?php echo aq_resize($gallery_image['full_url'],1170,400,true) ?>" alt="<?php echo esc_attr(get_the_title()) ?>"/></a>
									<?php endforeach; ?>
								</div>
