		...
		<nav class="pull-right">
			<ul>
				<?php foreach($parentMenus['header_top_menu'] as $header_top_menu_item): ?>
					<li><a href="<?php echo $header_top_menu_item->url ?>" target="<?php echo $header_top_menu_item->target; ?>" class="met_color_transition"><?php echo $header_top_menu_item->title; ?></a></li>
				<?php endforeach; ?>
			</ul>
		</nav>
		<?php endif; ?>
			...
			<aside class="clearfix">
				...
				<nav>
					<ul>
						...
						<li><a href="<?php echo $header_menu_item->url ?>"  target="<?php echo $header_menu_item->target; ?>" class="met_color_transition"><?php echo $header_menu_item->title; ?></a></li>
						<?php endforeach; ?>
					</ul>
				</nav>
				<?php endif; ?>
...
<nav class="met_content met_main_nav met_bgcolor3 clearfix"  <?php echo $_SESSION["shocoonwp_menu_type"] == 'sticky' || $_SESSION["shocoonwp_menu_type"] == '' ? 'data-fixed="1"' : '' ?>">
	<ul>
