...
function met_theme_customizer( $wp_customize ) {
	...
	/* ----------------------  */
	$wp_customize->add_section( $theme_slug."_header", array(
		'title' => 'Header',
		'description' => ''
	) );
	...
	$wp_customize->add_setting( $theme_slug."_social_header", array(
		'default'		=> '<a href="http://www.facebook.com/" target="_blank" class="met_color3 met_color_transition"><i class="icon-facebook"></i></a>
	...
	$wp_customize->add_setting( $theme_slug."_top_bar", array(
		'default' => '0',
		'type' => 'theme_mod',
		'transport' => 'refresh'
	) );

	$wp_customize->add_control( $theme_slug."_top_bar", array(
		'label' => 'Top Bar?',
		'section' => $theme_slug."_header",
		'type' => 'select',
		'choices' => $bool_options,
		'settings' => $theme_slug."_top_bar",
		//'priority' => 1,
	) );

	$wp_customize->add_setting( $theme_slug."_top_bar_content", array(
		'default'        => '<a href="mailto:mail@yourdomainname.com" class="pull-left met_color_transition"><i class="icon-envelope"></i>&nbsp;&nbsp;info@yourdomain.com</a>
		<a href="tel:+445875478547" class="pull-left met_color_transition"><i class="icon-phone"></i>&nbsp;&nbsp;+44 587 54 785 47</a>',
		'transport' => 'refresh',
	) );

	$wp_customize->add_control( new Textarea_Control( $wp_customize, $theme_slug."_top_bar_content", array(
		'label'   => 'Top Bar Content',
		'section' => $theme_slug."_header",
		'settings'   => $theme_slug."_top_bar_content",
	) ) );
	/* ----------------------  */
