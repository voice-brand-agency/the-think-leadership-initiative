...
?>
			...
			<div class="span12">
				<div id="<?php echo $widgetID ?>" class="met_img_with_text clearfix">
					...
					<div class="met_img_with_text_preview">
						...
						<?php else: ?>
							<div class="met_img_with_text_overlay met_bgcolor5_trans">
								<a href="<?php echo $image_link ?>" target="<?php echo $image_link_target ?>" class="met_portfolio_item_lb met_bgcolor5 met_color2"><i class="icon-arrow-right"></i></a>
							</div>
						<?php endif; ?>
					</div>
					...
					<article class="met_color2 met_bgcolor5" style="background-color: <?php echo $contentbox_bg ?>">
						<div>
							...
							<?php if(!empty($text)): ?><div><?php echo htmlspecialchars_decode($text) ?></div><?php endif; ?>
						</div>
					</article>
				</div>
			</div>
		...
		<style>
			...
			#<?php echo $widgetID ?> article.met_bgcolor5:after {
				background-color : <?php echo $contentbox_bg ?> !important;
			}
		</style>
<?php
	}
