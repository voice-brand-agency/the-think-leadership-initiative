...
?>
		...
		<style>
			...
			#<?php echo $widgetID ?>:before {
				border-color: <?php echo $background ?> transparent transparent transparent;
			}
			<?php endif; ?>
		...
		<div class="row-fluid">
			<div class="span12">
				<div id="<?php echo $widgetID ?>" class="met_cacoon_sidebar met_color2 met_bgcolor3 clearfix <?php if($arrow_position=='1'): ?>met_right_triangle<?php endif; ?>" style="font-size:<?php echo $font_size ?>;line-height:<?php echo $line_height ?>;background-color:<?php echo $background ?>!important;color:<?php echo $text_color ?>!important;">
